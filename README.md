...
### ⚡ Backend Developer | Node.js • Go • Databases • Scalable Systems  

🌍 From India | 💻 Love solving backend challenges | 🚀 Always learning & building  

---

## 🔥 What I Do  
- 🛠️ Build **backend systems, APIs & microservices**  
- ⚡ Work with **Node.js, Go, MongoDB, MySQL, PostgreSQL, Redis**  
- 🐳 Use **Docker** for containerization & deployment  
- 📊 Focus on **system performance, scalability, and clean architecture**  
